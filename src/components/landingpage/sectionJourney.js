...
export default function SectionJourney() {
    ...
    const journey = [
        { "image": require("../../media/journey_food_distribution.jpg"), "description": "Working for one year, we began to distribute food to the needy children on the streets. Now more than 110 children are fed every Sunday across different areas—a feat accomplished by only 7 members at the time." },
        { "image": require("../../media/journey_2.jpg"), "description": "During the pandemic, we helped provide medicines, oxygen and food to those who needed them. We also provided relief to those families financially devastated by the disease." },
        { "image": require("../../media/journey_3.jpg"), "description": "For the respite of animals, we installed a navkar mantra system in 6 Panjarapoles across Gujarat. Ghee, roti and lapsi were also provided to the cows."},
        ...
        { "image": require("../../media/journey_4.jpg"), "description": "The old-age homes are often overlooked and lack facilities. We provided them with clothes and installed a live dhokla machine that brought a bright smile on the faces of our dada-dadis." },
        ...
        { "image": require("../../media/journey_5.jpg"), "description": "We make it a point to spend time with specially-abled children, play with them and engage them in constructive activities like painting, art and crafts. We have also distributed 5000 notebooks to the needy students for unhindered access to quality education." },
